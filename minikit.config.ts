...
export const minikitConfig = {
  accountAssociation: {
    header:
      "eyJmaWQiOjI4MDg1NTYsInR5cGUiOiJjdXN0b2R5Iiwia2V5IjoiMHhmQzVFMzBGRWEzMTAxYTJFN0ZlZUUyNzBFOUE3MDdDYjFDMUE1ZDhkIn0",
    payload: "eyJkb21haW4iOiJibGFja2phY2stY2hpLXJ1c3QudmVyY2VsLmFwcCJ9",
    signature:
      "bxpT8BVdk7nLtLFlpuonUVvtbk5WthJEV/lmiCuo5yxGPVmqomtcAFJLGEW/XgiKtWFVnEDCUNbbttHjFUYs8Rw=",
  },
  miniapp: {
    version: "1",
    name: "Blackjack Neo",
